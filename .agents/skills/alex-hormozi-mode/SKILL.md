...
3. **Load the Wiki TOC** at `.Codex/skills/alex-hormozi-mode/wiki-toc.md` — this is the navigation file listing every page in the Hormozi wiki with descriptions and paths
