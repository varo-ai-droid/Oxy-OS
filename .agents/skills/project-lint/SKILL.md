...
2. **Project documentation** - AGENTS.md, me.md, memory.md
...
6. **Identify potential junk files:**
   ...
   - Files not referenced in AGENTS.md or other documentation
...
- File deletions
- Structural changes to AGENTS.md
- Renaming of important files
- Removal of code blocks

## Notes

- Never delete AGENTS.md, me.md, memory.md without explicit confirmation
